...
const NextJsLogo = () => {
  return (
    <div className="footer-nextjs-logo">
      <svg
        height="80"
        viewBox="0 0 148 90"
        version="1.1"
...
const VercelLogo = () => {
  return (
    <div className="footer-vercel-logo">
      <svg height="26" viewBox="0 0 284 65" fill="var(--geist-foreground)">
...
const Footer = () => {
  return (
    <div className="footer">
      <div className="text">Built by July</div>
